...
/*Crtanje gornje strane matrice
*/
void draw_top_side();

/*Iscrtavanje jednog reda matrice
	@param head lista koja ce biti ispisana u matrici
	@param row red matrice koji ce biti nacrtan
*/
void draw_one_row(LIST *head, int row);

/*Crtanje donje strane matrice
	@param head lista koja ce biti ispisana u matrici
	@param row red matrice koji ce biti nacrtan
*/
...
/*
	Pozivanje funkcija za crtanje gornje i donje strane matrice i crtanje 9 redova sa elementima koji su prosledjeni preko liste
	@param head lista koja ce biti ispisana u matrici
	@param row red matrice koji ce biti nacrtan
*/
